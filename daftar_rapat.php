...
<body class="bg-white p-8"> 
    ...
    <div class="max-w-7xl mx-auto bg-white shadow-md rounded-lg p-6">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<a href='daftar_hadir.php?id_rapat=" . $row["id"] . "' class='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-2'>Daftar Hadir</a>";
                            ...
                            echo "<a href='notulen.php?id_rapat=" . $row["id"] . "' class='bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded mr-2'>Notulen</a>";
        ...
        <div class="mt-6 text-center">
            <a href="tambah_rapat.php" class="bg-yellow-500 hover:bg-yello-700 p-2 rounded text-white">Tambah Rapat Baru</a>
        </div>
    </div>
